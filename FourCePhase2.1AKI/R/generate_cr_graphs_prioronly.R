...
generate_cr_graphs_prioronly <- function(siteid,base_table,obfuscation,obfuscation_level,kdigo_grade_table,ckd_valid,ckd_table,labs_cr) {
  currSiteId <- siteid
  ...
  ggplot2::ggsave(filename=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_PeakCr_Severe_AKI_PriorCrOnly.png")),plot=peak_cr_timeplot,width=12,height=9,units="cm")
  ...
  ggplot2::ggsave(filename=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_PeakCr_Severe_AKI_RawCr_PriorCrOnly.png")),plot=peak_cr_timeplot_raw,width=12,height=9,units="cm")
  ...
  ggplot2::ggsave(filename=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_PeakCr_KDIGOStage_AKI_PriorCrOnly.png")),plot=peak_cr_kdigo_timeplot,width=12,height=9,units="cm")
  ...
  ggplot2::ggsave(filename=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_PeakCr_KDIGOStage_AKI_RawCr_PriorCrOnly.png")),plot=peak_cr_kdigo_timeplot_raw,width=12,height=9,units="cm")
  ...
  try({
    ...
    ggplot2::ggsave(filename=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_PeakCr_KDIGOStage_CovidSevere_AKI_PriorCrOnly.png")),plot=peak_cr_kdigo_and_severe_timeplot,width=12,height=8,units="cm")
    ...
    ggplot2::ggsave(filename=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_PeakCr_KDIGOStage_CovidSevere_AKI_RawCr_PriorCrOnly.png")),plot=peak_cr_kdigo_and_severe_timeplot_raw,width=12,height=8,units="cm")
  ...
  ggplot2::ggsave(filename=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_CrFromAdm_KDIGOStage_AKI_PriorCrOnly.png")),plot=adm_to_aki_cr_kdigo_timeplot,width=12,height=9,units="cm")
  ...
  ggplot2::ggsave(filename=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_CrFromAdm_KDIGOStage_AKI_RawCr_PriorCrOnly.png")),plot=adm_to_aki_cr_kdigo_timeplot_raw,width=12,height=9,units="cm")
  ...
  ggplot2::ggsave(filename=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_CrFromAdm_KDIGOStage_CovidSevere_AKI_PriorCrOnly.png")),plot=adm_to_aki_cr_kdigo_and_severe_timeplot,width=12,height=8,units="cm")
  ...
  ggplot2::ggsave(filename=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_CrFromAdm_KDIGOStage_CovidSevere_AKI_RawCr_PriorCrOnly.png")),plot=adm_to_aki_cr_kdigo_and_severe_timeplot_raw,width=12,height=8,units="cm")
  ...
  write.csv(aki_30d_cr_summ,file=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_CrFromStart_Severe_AKI_PriorCrOnly.csv")),row.names=FALSE)
  ...
  ggplot2::ggsave(file=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_CrFromStart_Severe_AKI_PriorCrOnly.png")),plot=aki_30d_cr_timeplot,width=12,height=9,units="cm")
  ...
  ggplot2::ggsave(file=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_CrFromStart_Severe_AKI_RawCr_PriorCrOnly.png")),plot=aki_30d_cr_timeplot_raw,width=12,height=9,units="cm")
  ...
  ggplot2::ggsave(filename=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_CrfromStart_KDIGOStage_AKI_PriorCrOnly.png")),plot=aki_30d_cr_kdigo_timeplot,width=12,height=9,units="cm")
  ...
  ggplot2::ggsave(filename=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_CrfromStart_KDIGOStage_AKI_RawCr_PriorCrOnly.png")),plot=aki_30d_cr_kdigo_timeplot_raw,width=12,height=9,units="cm")
  ...
  ggplot2::ggsave(filename=file.path(getProjectOutputDirectory(), paste0(currSiteId,"_CrfromStart_KDIGOStage_CovidSevere_AKI_PriorCrOnly.png")),plot=aki_30d_cr_kdigo_and_severe_timeplot,width=12,height=8,units="cm")
