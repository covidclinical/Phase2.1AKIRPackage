...
run_time_to_event_analysis_nonckd <- function(siteid,
  ...
  for(i in 1:length(models_ckd_labels)) {
    ...
    try({
      ...
      write.csv(coxph_new_ckd_vcov,file=file.path(dir.output,paste0(currSiteId, "_TimeToEvent_NewCKD_CoxPH_",models_ckd_labels[i],"_vcov.csv")))
  ...
  for(i in 1:length(models_ckd_labels)) {
    ...
    try({
      ...
      coxph_new_ckd_vcov <- vcov(coxph_new_ckd)
      write.csv(coxph_new_ckd_vcov,file=file.path(dir.output,paste0(currSiteId, "_TimeToEvent_Death_NonCKD_CoxPH_",models_ckd_labels[i],"_vcov.csv")))
      coxph_new_ckd_plot <- survminer::ggforest(coxph_new_ckd,data=aki_index_nonckd)
  ...
  for(i in 1:length(models_ckd_labels)) {
    ...
    try({
      ...
      coxph_new_ckd_vcov <- vcov(coxph_new_ckd)
      write.csv(coxph_new_ckd_vcov,file=file.path(dir.output,paste0(currSiteId, "_TimeToEvent_NewCKD_AKIOnly_CoxPH_",models_ckd_labels[i],"_vcov.csv")))
  ...
  for(i in 1:length(models_ckd_labels)) {
    ...
    try({
      ...
      coxph_new_ckd_vcov <- vcov(coxph_new_ckd)
      write.csv(coxph_new_ckd_vcov,file=file.path(dir.output,paste0(currSiteId, "_TimeToEvent_Death_NonCKD_AKIOnly_CoxPH_",models_ckd_labels[i],"_vcov.csv")))
      coxph_new_ckd_plot <- survminer::ggforest(coxph_new_ckd,data=aki_index_nonckd_akionly)
  ...
  for(i in 1:length(models_ckd_labels)) {
    ...
    try({
      ...
      coxph_new_ckd_vcov <- vcov(coxph_new_ckd)
      write.csv(coxph_new_ckd_vcov,file=file.path(dir.output,paste0(currSiteId, "_TimeToEvent_Recovery_NonCKD_AKIOnly_CoxPH_",models_ckd_labels[i],"_vcov.csv")))
      coxph_new_ckd_plot <- survminer::ggforest(coxph_new_ckd,data=aki_index_nonckd_akionly)
